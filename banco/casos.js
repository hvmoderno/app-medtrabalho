...
{ id: 'caso-001',
  ...
  questoes: [
    { enunciado: 'Ainda no ambulatório da empresa, sobre o atendimento inicial e o transporte dos segmentos amputados, a conduta CORRETA é:',
      alts: [
        { t: 'Controlar o sangramento por compressão direta e elevação, e acondicionar os segmentos amputados envoltos em compressa umedecida com solução fisiológica dentro de saco plástico limpo e fechado, colocando esse saco em recipiente com gelo e água, sem contato direto do tecido com o gelo.', ok: true,
          why: 'Correta. A hemostasia inicial se faz por compressão direta, e o segmento amputado deve ser resfriado indiretamente: envolto em compressa úmida, isolado em saco fechado e só então posto sobre gelo com água, evitando congelamento e maceração do tecido.' },
        { t: 'Aplicar torniquete de rotina no antebraço e mergulhar os segmentos amputados diretamente em água gelada com gelo, para melhor conservação.', ok: false,
          why: 'Errada em dois pontos: torniquete não é a primeira medida quando o sangramento cede à compressão, e a imersão direta do tecido em água provoca maceração, inviabilizando o reimplante.' },
        { t: 'Lavar os segmentos com solução antisséptica alcoólica, secá-los e envolvê-los em gaze seca à temperatura ambiente.', ok: false,
          why: 'Errada. Antisséptico alcoólico e dessecação lesam o tecido a ser reimplantado; o segmento precisa ser mantido úmido e resfriado.' },
        { t: 'Descartar os segmentos amputados como resíduo biológico, pois após queda no piso da fábrica a contaminação inviabiliza qualquer reimplante.', ok: false,
          why: 'Errada. Contaminação não é contraindicação absoluta: a decisão sobre viabilidade cabe ao serviço de cirurgia da mão, e o segmento deve ser encaminhado junto com o paciente.' },
        { t: 'Congelar os segmentos em freezer ou em gelo seco, para reduzir ao máximo o metabolismo tecidual durante o transporte.', ok: false,
          why: 'Errada. O congelamento destrói o tecido; a meta é resfriamento próximo a zero grau sem formação de cristais de gelo.' }
      ],
    ...
    { enunciado: 'Quanto à comunicação do acidente à Previdência, diante da recusa manifestada pela empresa, a orientação tecnicamente CORRETA é:',
      alts: [
        { t: 'A comunicação é obrigatória e independe de discussão sobre culpa; se a empresa não a emitir, podem fazê-lo o próprio acidentado, seus dependentes, o sindicato, o médico assistente ou a autoridade pública, e a omissão da empresa não retira o direito do trabalhador.', ok: true,
          why: 'Correta. A obrigação de comunicar é objetiva, não depende de apuração de responsabilidade, e a lei prevê legitimados subsidiários exatamente para a hipótese de omissão do empregador.' },
        { t: 'A comunicação fica suspensa até o encerramento da investigação interna, pois emitir o documento antes de definida a causa equivale a reconhecer responsabilidade da empresa.', ok: false,
          why: 'Errada. Comunicar não é confessar culpa: o documento é instrumento de registro e de acesso a direitos, e a investigação corre em paralelo.' },
        { t: 'Comprovada a burla do dispositivo de segurança pelo trabalhador, o evento deixa de ser acidente do trabalho e a comunicação torna-se indevida.', ok: false,
          why: 'Errada. A caracterização do acidente do trabalho não é afastada por conduta imprudente do empregado; culpa da vítima não descaracteriza o evento para fins previdenciários.' },
        { t: 'A comunicação só é devida quando o afastamento ultrapassa quinze dias, momento em que passa a haver benefício a ser concedido.', ok: false,
          why: 'Errada. O marco de quinze dias diz respeito a quem paga o período inicial de afastamento, não à obrigação de comunicar, que existe inclusive em acidente sem afastamento.' },
        { t: 'Basta o registro do atendimento no prontuário do ambulatório e a informação ao setor de recursos humanos, dispensada comunicação formal ao órgão previdenciário.', ok: false,
          why: 'Errada. O registro interno não substitui a comunicação formal, que tem função previdenciária, estatística e epidemiológica.' }
      ],
    ...
    { enunciado: 'Na investigação do acidente conduzida pelo serviço de segurança e saúde da empresa, a abordagem tecnicamente adequada é:',
      alts: [
        { t: 'Buscar as causas organizacionais e técnicas que tornaram possível o ato — ausência de proteção fixa e de bloqueio de energia, pressão por produção, tolerância gerencial à burla — em vez de encerrar a análise no comportamento do operador.', ok: true,
          why: 'Correta. A investigação moderna busca causas raízes nos níveis técnico e organizacional; o comportamento inseguro é sintoma de falhas do sistema, e parar nele impede a prevenção de novos eventos.' },
        { t: 'Concluir por ato inseguro do trabalhador, aplicar advertência disciplinar e reforçar o treinamento de procedimento operacional como medida corretiva principal.', ok: false,
          why: 'Errada. Culpabilizar e treinar são as medidas de menor eficácia da hierarquia de controles e deixam intacta a condição que permitiu a lesão.' },
        { t: 'Restringir a análise à conformidade documental do programa de gerenciamento de riscos, pois a investigação de causas cabe exclusivamente à auditoria fiscal do trabalho.', ok: false,
          why: 'Errada. A investigação interna é atribuição do serviço de segurança e saúde e da comissão interna, sem prejuízo da atuação fiscal e da vigilância em saúde.' },
        { t: 'Considerar o evento imprevisível e classificá-lo como fatalidade, uma vez que a máquina operava dentro do ciclo normal de produção.', ok: false,
          why: 'Errada. Zona de prensagem acessível com máquina energizada é risco previsível e conhecido; não há fatalidade a reconhecer.' },
        { t: 'Adiar a análise até a alta médica do acidentado, para que ele possa participar pessoalmente da reconstituição do evento.', ok: false,
          why: 'Errada. A investigação deve ser imediata, sob pena de perda de evidências; a oitiva do acidentado é desejável, mas pode ser feita depois e não justifica paralisar a apuração.' }
      ],
    ...
    { enunciado: 'Sobre as repercussões previdenciárias e trabalhistas do afastamento, é CORRETO afirmar que:',
      alts: [
        { t: 'A empresa arca com a remuneração dos quinze primeiros dias de afastamento e, a partir daí, o trabalhador passa a benefício por incapacidade temporária de natureza acidentária, com direito à manutenção do recolhimento do fundo de garantia e à estabilidade provisória de doze meses após a cessação do benefício.', ok: true,
          why: 'Correta. Reúne os três efeitos clássicos do afastamento acidentário superior a quinze dias: pagamento inicial pela empresa, benefício de espécie acidentária e estabilidade de doze meses contada da cessação.' },
        { t: 'Por se tratar de acidente com culpa do empregado, o benefício será concedido em espécie previdenciária comum, sem repercussão acidentária.', ok: false,
          why: 'Errada. A natureza acidentária decorre do nexo com o trabalho, não do juízo sobre a conduta do acidentado.' },
        { t: 'A estabilidade provisória se conta a partir da data do acidente, e não da cessação do benefício.', ok: false,
          why: 'Errada. A contagem da garantia de emprego se inicia com a cessação do benefício acidentário, não com o evento.' },
        { t: 'A concessão de benefício acidentário exige carência mínima de contribuições, que não estará cumprida se o vínculo for recente.', ok: false,
          why: 'Errada. Os benefícios decorrentes de acidente do trabalho independem de carência.' },
        { t: 'Reconhecida a amputação, o trabalhador deve ser encaminhado diretamente à aposentadoria por incapacidade permanente, dada a irreversibilidade da perda anatômica.', ok: false,
          why: 'Errada. Perda anatômica irreversível não equivale a incapacidade total e permanente para todo e qualquer trabalho; o caminho é reabilitação e, conforme a sequela, auxílio-acidente.' }
      ],
    ...
    { enunciado: 'Considerando que se trata de acidente do trabalho grave, com mutilação, a conduta CORRETA em relação à vigilância e à prevenção é:',
      alts: [
        { t: 'Notificar o agravo ao sistema de informação de agravos de notificação, além de comunicar o acidente à Previdência, e adotar como medida prioritária a proteção da zona de prensagem e o procedimento de bloqueio de energia antes de qualquer intervenção na matriz.', ok: true,
          why: 'Correta. Acidente de trabalho grave é agravo de notificação compulsória no sistema de vigilância em saúde, obrigação que coexiste com a comunicação previdenciária, e a medida preventiva eficaz atua na máquina, não no comportamento.' },
        { t: 'A comunicação do acidente à Previdência substitui a notificação em saúde, pois ambas alimentam a mesma base nacional de dados.', ok: false,
          why: 'Errada. São instrumentos distintos, com finalidades e fluxos diferentes: um é previdenciário, o outro é de vigilância em saúde, e um não dispensa o outro.' },
        { t: 'A notificação em saúde só é devida em acidente com óbito, não sendo exigível em amputação.', ok: false,
          why: 'Errada. Acidentes graves, entre eles os que causam mutilação, integram a lista de notificação, e não apenas os fatais.' },
        { t: 'A prioridade preventiva é a substituição do comando bimanual por sensores de presença associados a campanha comportamental de uso correto dos equipamentos de proteção individual.', ok: false,
          why: 'Errada em parte: proteção por sensores pode integrar a solução, mas atribuir a prioridade a campanha comportamental e a equipamento individual inverte a hierarquia de controles em risco mecânico.' },
        { t: 'Basta atualizar o inventário de riscos com a inclusão do risco mecânico já materializado, aguardando o próximo ciclo de revisão do programa para propor medidas.', ok: false,
          why: 'Errada. Após acidente grave a revisão do programa e a adoção de medidas são imediatas, não podem aguardar ciclo ordinário.' }
      ],
...
{ id: 'caso-002',
  ...
  questoes: [
    { enunciado: 'Sobre a caracterização do evento, a análise CORRETA é:',
      alts: [
        { t: 'Trata-se de acidente equiparado a acidente do trabalho, pois ocorreu no percurso entre a residência e o local de trabalho, sendo irrelevantes o meio de transporte utilizado e a propriedade do veículo, e a breve parada no mesmo itinerário não configura interrupção que rompa a proteção.', ok: true,
          why: 'Correta. A equiparação do trajeto não depende do meio de transporte nem de o veículo ser fornecido pela empresa, e pequenos desvios ou paradas compatíveis com o percurso habitual não descaracterizam o evento.' },
        { t: 'Não se caracteriza acidente do trabalho porque a trabalhadora utilizava veículo próprio, hipótese em que a proteção só alcança o transporte fornecido pelo empregador.', ok: false,
          why: 'Errada. A proteção do trajeto abrange qualquer meio de locomoção, inclusive veículo próprio e transporte público.' },
        { t: 'A parada de dez minutos na padaria configura interrupção do percurso por interesse pessoal e afasta integralmente a equiparação legal.', ok: false,
          why: 'Errada. A jurisprudência e a doutrina admitem paradas breves e desvios habituais compatíveis com o itinerário; o que rompe a proteção é a alteração substancial do percurso por motivo estranho.' },
        { t: 'Como o evento ocorreu antes do início da jornada, trata-se de acidente comum, com repercussão exclusivamente previdenciária ordinária.', ok: false,
          why: 'Errada. O trajeto é protegido justamente porque ocorre fora da jornada e fora das dependências; exigir que esteja dentro da jornada anula o instituto.' },
        { t: 'Somente haveria acidente do trabalho se a empresa exigisse o uso da motocicleta como instrumento de trabalho, o que a converteria em acidente típico.', ok: false,
          why: 'Errada. Se a motocicleta fosse instrumento de trabalho o acidente seria típico, mas a ausência dessa condição não impede a equiparação pelo trajeto.' }
      ],
    ...
    { enunciado: 'Quanto ao documento de comunicação do acidente, a conduta CORRETA do médico do trabalho é:',
      alts: [
        { t: 'Orientar a emissão da comunicação inicial pela empresa, registrando a natureza do evento como acidente de trajeto, e esclarecer que, se a empresa persistir na recusa, a própria trabalhadora, seus dependentes, o sindicato, o médico assistente ou a autoridade pública podem fazê-lo, sem prejuízo da responsabilização da empresa pela omissão.', ok: true,
          why: 'Correta. Existe tipo próprio de comunicação inicial, o registro deve refletir a natureza do evento e a lei prevê legitimados subsidiários, com penalidade à empresa que descumpre o dever de comunicar.' },
        { t: 'Emitir a comunicação como reabertura, uma vez que já houve atendimento hospitalar prévio ao registro na empresa.', ok: false,
          why: 'Errada. A reabertura destina-se a reinício de tratamento ou agravamento de lesão de acidente já comunicado, não ao primeiro registro de um evento novo.' },
        { t: 'Aguardar a conclusão do inquérito policial sobre a responsabilidade do condutor do automóvel antes de qualquer comunicação.', ok: false,
          why: 'Errada. A responsabilidade civil de terceiro é irrelevante para a caracterização previdenciária, e a comunicação não pode ficar condicionada a apuração externa.' },
        { t: 'Emitir a comunicação apenas ao final do afastamento, com a informação consolidada do tempo total de incapacidade.', ok: false,
          why: 'Errada. A comunicação é imediata; dados de evolução são objeto de comunicações posteriores, não motivo para postergar a inicial.' },
        { t: 'Deixar a critério da trabalhadora, pois em acidente de trajeto a comunicação é facultativa e depende de manifestação de interesse do segurado.', ok: false,
          why: 'Errada. A comunicação é obrigatória para a empresa; a legitimação do segurado é subsidiária, e não substitutiva da obrigação legal.' }
      ],
    ...
    { enunciado: 'Sobre os efeitos do afastamento, considerando que ele deve superar quinze dias, é CORRETO afirmar que:',
      alts: [
        { t: 'A trabalhadora fará jus a benefício por incapacidade temporária de natureza acidentária, com manutenção dos depósitos do fundo de garantia durante o afastamento e garantia de emprego de doze meses após a cessação do benefício.', ok: true,
          why: 'Correta. O acidente de trajeto, por ser equiparado, gera os mesmos efeitos acidentários do acidente típico, inclusive quanto a fundo de garantia e garantia de emprego.' },
        { t: 'Por não haver relação com a atividade desempenhada, o benefício será de espécie previdenciária comum, sem estabilidade nem manutenção do fundo de garantia.', ok: false,
          why: 'Errada. A equiparação legal existe exatamente para conferir ao trajeto os mesmos efeitos do acidente típico.' },
        { t: 'A garantia de emprego só se aplica se a trabalhadora receber também auxílio-acidente ao final do tratamento.', ok: false,
          why: 'Errada. A garantia de emprego decorre do afastamento acidentário superior a quinze dias com percepção do benefício, independentemente de haver sequela indenizável ao final.' },
        { t: 'Durante o afastamento o contrato de trabalho é extinto de pleno direito, sendo restabelecido apenas se houver alta com aptidão.', ok: false,
          why: 'Errada. O contrato fica suspenso ou interrompido conforme o período, mas não é extinto pelo afastamento.' },
        { t: 'Cabe à empresa pagar integralmente a remuneração durante todo o período de afastamento, ressarcindo-se depois junto à Previdência.', ok: false,
          why: 'Errada. A empresa responde pelos quinze primeiros dias; a partir do décimo sexto o pagamento é do órgão previdenciário, sem sistema de ressarcimento.' }
      ],
    ...
    { enunciado: 'Quatro meses depois, a trabalhadora retorna com consolidação da fratura, marcha sem auxílio, mas com limitação da dorsiflexão do tornozelo e dor ao permanecer longos períodos em pé. Sua função é administrativa, predominantemente sentada. A conduta CORRETA do médico do trabalho no exame de retorno é:',
      alts: [
        { t: 'Realizar o exame de retorno ao trabalho, considerá-la apta para a função administrativa e registrar orientação de alternância postural e restrição a permanência prolongada em pé, com reavaliação programada.', ok: true,
          why: 'Correta. A aptidão é sempre para uma função concreta: a limitação descrita não impede o trabalho predominantemente sentado, e a conduta é aptidão com restrição funcional definida e acompanhamento.' },
        { t: 'Considerá-la inapta em definitivo, pois sequela osteoarticular permanente é incompatível com o retorno ao trabalho.', ok: false,
          why: 'Errada. Sequela não equivale a inaptidão: a pergunta é se a limitação impede o desempenho seguro daquela função, e neste caso não impede.' },
        { t: 'Dispensar o exame de retorno, pois a função é administrativa e não há exposição a risco ocupacional que o justifique.', ok: false,
          why: 'Errada. O exame de retorno é obrigatório após afastamento prolongado por doença ou acidente, seja qual for a natureza do risco da função.' },
        { t: 'Encaminhá-la à reabilitação profissional para mudança de função, uma vez que a sequela impede o retorno à atividade anteriormente exercida.', ok: false,
          why: 'Errada. Não há incompatibilidade entre a sequela e a função exercida; encaminhamento à reabilitação sem essa incompatibilidade é medida desnecessária e potencialmente discriminatória.' },
        { t: 'Registrar no atestado de saúde ocupacional o diagnóstico e a descrição da sequela, para que a chefia possa dimensionar as tarefas.', ok: false,
          why: 'Errada. O documento de aptidão comunica a conclusão e as restrições funcionais necessárias, sem diagnóstico; a chefia recebe a limitação, não a doença.' }
      ],
    ...
    { enunciado: 'A empresa, diante do caso, decide agir sobre o risco de acidente de trajeto de seus empregados. A medida de maior consistência técnica é:',
      alts: [
        { t: 'Incluir o deslocamento na análise de riscos da organização, com ações sobre horários e escalas que evitam picos de risco, incentivo a modais mais seguros, manutenção de veículos usados a serviço e programa de direção defensiva, reconhecendo que o trajeto é evento sobre o qual a empresa tem influência parcial.', ok: true,
          why: 'Correta. Ainda que o controle do ambiente viário escape à empresa, há determinantes organizacionais do risco de trajeto — jornada, escala, pressão por horário, condição do veículo — sobre os quais a gestão atua.' },
        { t: 'Nada há a fazer em termos de prevenção, pois o acidente de trajeto ocorre em via pública, fora do alcance da gestão de segurança da empresa.', ok: false,
          why: 'Errada. É a posição mais confortável e a menos defensável tecnicamente: parte do risco é organizacional.' },
        { t: 'Exigir declaração de todos os empregados sobre o meio de transporte utilizado, condicionando a proteção acidentária ao uso do meio declarado.', ok: false,
          why: 'Errada. A proteção legal não pode ser condicionada por ato da empresa, e a exigência não produz prevenção alguma.' },
        { t: 'Proibir o uso de motocicleta no deslocamento e advertir quem descumprir, medida que elimina o principal fator de gravidade.', ok: false,
          why: 'Errada. A empresa não tem poder sobre a escolha do meio de locomoção pessoal do empregado, e a proibição não é medida de prevenção exequível nem legítima.' },
        { t: 'Contratar seguro de acidentes pessoais para todos, o que dispensa investimento em outras medidas por transferir o risco à seguradora.', ok: false,
          why: 'Errada. Seguro transfere consequência financeira, não reduz a ocorrência; não é medida de prevenção.' }
      ],
