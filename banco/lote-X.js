...
{ id: 'q-2.2-080', tema: '2.2', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'A exposição se associa a lombalgia e alterações da coluna, e depende do assento, da suspensão do veículo, da superfície de rolamento e da postura mantida — de modo que a intervenção passa por manutenção do equipamento e das vias, não apenas por rodízio de operadores.', ok: true,
      why: 'Correta. Assento, suspensão e piso são as variáveis que efetivamente reduzem a dose.' },
    { t: 'A vibração de corpo inteiro afeta principalmente as mãos e os punhos.', ok: false,
      why: 'Errada. Esse é o perfil da vibração localizada de mãos e braços.' },
    { t: 'O estado de conservação do assento não influencia a exposição.', ok: false,
      why: 'Errada. O assento com suspensão adequada é um dos principais atenuadores.' },
    { t: 'A postura adotada durante a operação é irrelevante para o efeito sobre a coluna.', ok: false,
      why: 'Errada. Postura em torção associada à vibração agrava o efeito lombar.' },
    { t: 'A avaliação da exposição dispensa a medição, bastando o relato do operador.', ok: false,
...
{ id: 'q-2.2-081', tema: '2.2', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    { t: 'O risco principal está na descompressão inadequada, com formação de bolhas e doença descompressiva, exigindo tabelas de descompressão, controle rigoroso do tempo de exposição e disponibilidade de recompressão — além de restrição a voo após a exposição.', ok: true,
      why: 'Correta. A descompressão é a etapa crítica, e a redução adicional de pressão no voo agrava.' },
    { t: 'O risco se concentra na fase de compressão inicial.', ok: false,
      why: 'Errada. A fase crítica é a descompressão.' },
    { t: 'Após a exposição, não há restrição para viagem aérea.', ok: false,
      why: 'Errada. A menor pressão em cabine favorece a formação de bolhas; há intervalo mínimo recomendado.' },
    { t: 'A doença descompressiva se manifesta exclusivamente durante a descompressão.', ok: false,
      why: 'Errada. Pode se manifestar horas após o retorno à pressão ambiente.' },
    { t: 'Trabalhos em ar comprimido dispensam registro individual das exposições.', ok: false,
      why: 'Errada. O registro é exigência e permite reconstituir o histórico de exposições.' }
  ],
...
{ id: 'q-2.4-080', tema: '2.4', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'A classificação considera a patogenicidade para o ser humano, a existência de profilaxia e tratamento eficazes e o risco de disseminação na comunidade — critérios que determinam o nível de contenção exigido para a manipulação.', ok: true,
      why: 'Correta. São os critérios que compõem a classificação e definem a contenção.' },
    { t: 'A classificação depende apenas da gravidade da doença que o agente causa.', ok: false,
      why: 'Errada. Disponibilidade de profilaxia e risco de disseminação também compõem o critério.' },
    { t: 'O nível de contenção é definido pelo tipo de instituição, não pelo agente manipulado.', ok: false,
      why: 'Errada. É determinado pelo agente e pelo procedimento realizado.' },
    { t: 'Procedimentos geradores de aerossol não alteram o nível de contenção necessário.', ok: false,
      why: 'Errada. Elevam a exigência de contenção em relação à manipulação convencional.' },
    { t: 'A existência de vacina eficaz não influencia a classificação do agente.', ok: false,
...
{ id: 'q-2.4-081', tema: '2.4', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'A segregação na origem é a medida que mais reduz o risco para quem manuseia o resíduo adiante, e os perfurocortantes exigem recipiente rígido com limite de preenchimento respeitado — o preenchimento excessivo é causa frequente de acidente na coleta.', ok: true,
      why: 'Correta. Quem se acidenta com má segregação costuma ser quem coleta, não quem descartou.' },
    { t: 'A segregação pode ser feita no ponto de destinação final, sem prejuízo.', ok: false,
      why: 'Errada. Segregação tardia expõe todos os que manuseiam o resíduo no percurso.' },
    { t: 'Recipientes de perfurocortantes podem ser preenchidos até a borda.', ok: false,
      why: 'Errada. Há limite de preenchimento, e ultrapassá-lo causa acidentes na coleta.' },
    { t: 'Trabalhadores da limpeza não integram os grupos de risco biológico do estabelecimento.', ok: false,
      why: 'Errada. Estão entre os mais expostos a acidentes com perfurocortantes.' },
    { t: 'O plano de gerenciamento de resíduos não tem interface com saúde do trabalhador.', ok: false,
...
{ id: 'q-2.6-080', tema: '2.6', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'O limite é referência de avaliação e não meta de projeto: a hierarquia de controle impõe buscar a menor exposição exequível, de modo que resultado abaixo do limite não encerra a obrigação de reduzir quando há medida viável disponível.', ok: true,
      why: 'Correta. Conformidade não é sinônimo de otimização.' },
    { t: 'Atingir valor abaixo do limite encerra a obrigação de adotar medidas adicionais.', ok: false,
      why: 'Errada. Havendo medida viável de redução, ela permanece exigível.' },
    { t: 'O limite deve ser usado como meta de projeto de novas instalações.', ok: false,
      why: 'Errada. Projetar para o limite deixa a instalação sem margem para variação e degradação.' },
    { t: 'A variabilidade das exposições não precisa ser considerada na comparação com o limite.', ok: false,
      why: 'Errada. É preciso considerar a dispersão dos resultados, não apenas a média.' },
    { t: 'A eficácia dos controles instalados dispensa reavaliação periódica.', ok: false,
...
{ id: 'q-2.3-080', tema: '2.3', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'A fração relevante para o efeito pulmonar profundo é a respirável, o que exige amostragem seletiva por tamanho de partícula — e a poeira visível no ambiente não é indicador confiável da fração que atinge os alvéolos.', ok: true,
      why: 'Correta. O que se vê é a fração grossa; o que adoece é a que não se vê.' },
    { t: 'A quantidade de poeira visível no ar indica adequadamente o risco respiratório.', ok: false,
      why: 'Errada. A fração respirável não é visível a olho nu.' },
    { t: 'Todas as frações de poeira depositam-se igualmente nos alvéolos.', ok: false,
      why: 'Errada. A deposição depende do diâmetro aerodinâmico das partículas.' },
    { t: 'A umidificação do processo não reduz a geração de poeira respirável.', ok: false,
      why: 'Errada. É medida de controle reconhecida e eficaz quando bem aplicada.' },
    { t: 'O teor de sílica no material não influencia o limite aplicável.', ok: false,
...
{ id: 'q-1.3-080', tema: '1.3', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'Permitem estimar incidência e a sequência temporal entre exposição e desfecho, mas são vulneráveis a perdas de seguimento — e a perda diferencial, quando os que saem diferem sistematicamente dos que ficam, compromete a validade dos resultados.', ok: true,
      why: 'Correta. Perda diferencial é a principal ameaça à validade em coortes ocupacionais longas.' },
    { t: 'Coortes não permitem estimar incidência.', ok: false,
      why: 'Errada. É justamente o delineamento adequado para isso.' },
    { t: 'Perdas de seguimento não comprometem os resultados se forem numericamente pequenas.', ok: false,
      why: 'Errada. O que importa é se a perda é diferencial, não apenas o seu tamanho.' },
    { t: 'A coorte histórica não é aplicável em estudos ocupacionais.', ok: false,
      why: 'Errada. É delineamento muito usado, apoiado em registros de exposição pretéritos.' },
    { t: 'A coorte elimina o efeito do trabalhador sadio.', ok: false,
      why: 'Errada. O efeito persiste, sobretudo quando a comparação é com a população geral.' }
  ],
...
{ id: 'q-1.3-081', tema: '1.3', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    { t: 'Um fator confundidor associa-se à exposição e ao desfecho sem ser etapa intermediária do mecanismo causal — e ajustar por uma variável que é mediadora do efeito, e não confundidora, remove parte do próprio efeito que se quer estimar.', ok: true,
      why: 'Correta. Ajustar por mediador é erro tão relevante quanto deixar de ajustar por confundidor.' },
    { t: 'Toda variável associada ao desfecho deve ser incluída como ajuste.', ok: false,
      why: 'Errada. Incluir mediadores ou colisores introduz viés em vez de removê-lo.' },
    { t: 'O confundimento pode ser eliminado apenas na fase de análise dos dados.', ok: false,
      why: 'Errada. Também se controla no desenho, por restrição, pareamento ou aleatorização.' },
    { t: 'A randomização não tem efeito sobre o confundimento por variáveis não medidas.', ok: false,
      why: 'Errada. É justamente sua principal vantagem, embora raramente seja viável em estudos ocupacionais.' },
    { t: 'O tabagismo nunca atua como confundidor em estudos de exposição ocupacional.', ok: false,
      why: 'Errada. É confundidor clássico quando se associa tanto à ocupação quanto ao desfecho.' }
  ],
...
{ id: 'q-2.9-080', tema: '2.9', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'A dose interna integra todas as vias de absorção e reflete fatores individuais como carga de trabalho, ventilação pulmonar e uso efetivo de proteção — motivo pelo qual dois trabalhadores no mesmo ambiente podem apresentar indicadores biológicos muito distintos.', ok: true,
      why: 'Correta. É a vantagem do indicador biológico sobre a medição ambiental.' },
    { t: 'A concentração ambiental determina univocamente a dose interna do trabalhador.', ok: false,
      why: 'Errada. Esforço, ventilação pulmonar, via cutânea e proteção efetiva modificam a relação.' },
    { t: 'A carga de trabalho não influencia a quantidade absorvida por via respiratória.', ok: false,
      why: 'Errada. Maior esforço aumenta o volume-minuto e, portanto, a absorção.' },
    { t: 'O monitoramento biológico substitui integralmente a avaliação ambiental.', ok: false,
      why: 'Errada. São complementares: um mede a pessoa, o outro identifica onde intervir.' },
    { t: 'Diferenças entre trabalhadores do mesmo setor indicam necessariamente erro analítico.', ok: false,
