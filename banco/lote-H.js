...
{ id: 'q-7.2-041', tema: '7.2', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'A empresa emite documento próprio da exposição, lastreado em laudo de profissional habilitado.', ok: true,
      why: 'Correta. Informação inexata tem consequências previdenciárias e legais.' },
    { t: 'O trabalhador preenche o documento com base em seu relato sobre as condições em que trabalhou.', ok: false,
      why: 'Errada. É emitido pela empresa, com base em laudo técnico.' },
    { t: 'A empresa emite o documento, cuja emissão é facultativa e depende de solicitação judicial prévia.', ok: false,
      why: 'Errada. É obrigação da empresa, com prazos e situações definidos.' },
    { t: 'A empresa emite o documento, que pode descrever a exposição de forma genérica por setor da planta.', ok: false,
      why: 'Errada. A descrição é individualizada por trabalhador, função e período.' },
    { t: 'A empresa emite o documento, sem que a ausência do laudo técnico comprometa sua validade.', ok: false,
...
{ id: 'q-2.3-051', tema: '2.3', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    ...
    { t: 'Deve identificar produto e perigos, substituindo o rótulo a ficha de informações de segurança.', ok: false,
      why: 'Errada. São documentos complementares, com níveis de detalhe distintos.' },
    { t: 'Deve identificar produto e perigos, não se aplicando no país a padronização internacional adotada.', ok: false,
      why: 'Errada. O sistema harmonizado de classificação e rotulagem foi adotado como referência.' },
    { t: 'Deve identificar produto e perigos, dispensando capacitação por serem os rótulos autoexplicativos.', ok: false,
