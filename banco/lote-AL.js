...
{ id: 'q-4.4-120', tema: '4.4', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    ...
    { t: 'Identifica sensibilização, podendo as substâncias trazidas pelo trabalhador ser aplicadas na forma bruta, como usadas.', ok: false,
      why: 'Errada. Concentração e veículo inadequados produzem reação irritativa ou sensibilização ativa.' },
    { t: 'Identifica sensibilização às substâncias testadas, sendo a leitura em tempo único suficiente para a interpretação.', ok: false,
      why: 'Errada. Leituras em tempos distintos permitem diferenciar reação irritativa de alérgica.' },
    { t: 'Identifica sensibilização, e o resultado positivo dispensa a análise de relevância clínica e ocupacional do achado.', ok: false,
...
{ id: 'q-4.5-110', tema: '4.5', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    ...
    { t: 'Decorre de exposição única de altíssima intensidade, sendo a perda dela decorrente sempre reversível com repouso.', ok: false,
      why: 'Errada. Pode ser permanente, sobretudo quando a avaliação é tardia.' },
    { t: 'Decorre de exposição única de altíssima intensidade, podendo a avaliação aguardar o próximo exame periódico.', ok: false,
      why: 'Errada. É situação de avaliação urgente, pela possibilidade de perda permanente.' },
    { t: 'Decorre de exposição sonora única, não sendo explosões e disparos causas ocupacionais relevantes desse quadro.', ok: false,
...
{ id: 'q-4.6-110', tema: '4.6', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    ...
    { t: 'Abrange agressões e ameaças, sendo relevante para a saúde do trabalhador apenas a agressão física com lesão.', ok: false,
      why: 'Errada. Ameaças e agressões verbais repetidas têm repercussão documentada em saúde mental.' },
    { t: 'Abrange agressões físicas e verbais, resumindo-se a prevenção ao treinamento do trabalhador para lidar com conflito.', ok: false,
      why: 'Errada. Layout, dimensionamento de equipe, tempo de espera e protocolos têm maior alcance.' },
    { t: 'Abrange agressões físicas, verbais e ameaças, ocorrências que não são objeto de registro nem de notificação.', ok: false,
...
{ id: 'q-4.8-110', tema: '4.8', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    ...
    { t: 'O registro nominal viabiliza o reconhecimento futuro, podendo ser descartado ao fim das atividades com o agente.', ok: false,
      why: 'Errada. A latência exige guarda prolongada, muito além do fim da atividade.' },
    { t: 'O registro nominal atende a exigência documental, sem que a vigilância pós-ocupacional tenha justificativa técnica.', ok: false,
      why: 'Errada. É justificada pela latência longa desses agravos.' },
    { t: 'O registro nominal é da empresa, não tendo o trabalhador direito de receber informação sobre suas exposições.', ok: false,
...
{ id: 'q-5.4-120', tema: '5.4', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'Deve confrontar o quadro clínico com gesto, força, repetitividade, postura e pausas da atividade real.', ok: true,
      why: 'Correta. Sem descrever a atividade não há como julgar plausibilidade nem nexo.' },
    { t: 'Deve confrontar o quadro com a atividade, afastando o diagnóstico a ausência de alteração em exame de imagem.', ok: false,
      why: 'Errada. Vários quadros osteomusculares relacionados ao trabalho não têm tradução em imagem.' },
    { t: 'Deve confrontar o quadro com a atividade, afastando o nexo a presença de alteração degenerativa em imagem.', ok: false,
      why: 'Errada. Alterações degenerativas são prevalentes e podem coexistir como concausa.' },
    { t: 'Deve confrontar o quadro clínico com a atividade, podendo esta ser descrita pela denominação do cargo ocupado.', ok: false,
      why: 'Errada. O cargo não descreve gesto, força, repetitividade nem pausa.' },
    { t: 'Deve confrontar o quadro com a atividade, sendo o exame físico dispensável quando há exames de imagem.', ok: false,
      why: 'Errada. O exame físico é elemento central e insubstituível na avaliação.' }
  ],
...
{ id: 'q-5.5-110', tema: '5.5', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    ...
    { t: 'Concluir por incapacidade total exige fundamentação, sendo a idade avançada isoladamente suficiente para tanto.', ok: false,
      why: 'Errada. É fator a considerar na viabilidade da reabilitação, não critério isolado.' },
    { t: 'Concluir por incapacidade total exige análise de reabilitação, à qual escolaridade e experiência prévia são alheias.', ok: false,
      why: 'Errada. São elementos que compõem a viabilidade concreta da requalificação.' },
    { t: 'Concluir por incapacidade total cabe ao perito, sendo a avaliação de reabilitação etapa posterior e independente.', ok: false,
      why: 'Errada. A viabilidade de reabilitação integra a fundamentação da própria conclusão.' }
  ],
...
{ id: 'q-4.10-100', tema: '4.10', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    { t: 'O levantamento deve ser dirigido ao risco da função, e a recusa, registrada, deve ser reavaliada periodicamente.', ok: true,
      why: 'Correta. Recusa registrada não encerra o assunto; reabordar com informação muda decisões.' },
    { t: 'O levantamento deve ser idêntico para todas as funções da empresa, garantindo tratamento uniforme aos trabalhadores.', ok: false,
      why: 'Errada. É dirigido ao risco específico de cada função.' },
    { t: 'O levantamento deve ser dirigido ao risco da função, encerrando a recusa registrada a abordagem do tema.', ok: false,
      why: 'Errada. A reabordagem periódica com informação adequada é conduta apropriada.' },
    { t: 'O levantamento deve ser dirigido ao risco da função, bastando o relato do trabalhador quanto às vacinas recebidas.', ok: false,
      why: 'Errada. A comprovação documental é o que permite decidir corretamente diante de uma exposição.' },
    { t: 'O levantamento deve ser dirigido ao risco da função, sem que o registro vacinal integre o prontuário ocupacional.', ok: false,
...
{ id: 'q-6.2-110', tema: '6.2', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    { t: 'Deve verificar se as adaptações foram implementadas, se a alocação é a acordada e se há barreiras atitudinais.', ok: true,
      why: 'Correta. Rampa se constrói; barreira atitudinal exige trabalho contínuo com a equipe.' },
    { t: 'Deve verificar se as adaptações físicas foram implementadas, o que, uma vez confirmado, assegura a inclusão efetiva.', ok: false,
      why: 'Errada. Barreiras atitudinais persistem e comprometem a permanência.' },
    { t: 'Deve verificar adaptações e alocação, ficando as barreiras atitudinais fora do conceito legal de barreira.', ok: false,
      why: 'Errada. São expressamente previstas entre os tipos de barreira.' },
    { t: 'Deve verificar adaptações e barreiras atitudinais, sendo atribuição exclusiva da área de recursos humanos.', ok: false,
      why: 'Errada. O serviço de saúde ocupacional participa da verificação de compatibilidade e adaptações.' },
    { t: 'Deve verificar adaptações e alocação, sendo a rotatividade desse grupo indicador sem relevância para a gestão.', ok: false,
...
{ id: 'q-6.3-110', tema: '6.3', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'O índice de massa corporal isolado não é critério de aptidão, e turnos e oferta alimentar integram a determinação.', ok: true,
      why: 'Correta. O trabalho é parte do problema, não apenas o hábito do trabalhador.' },
    { t: 'O índice de massa corporal elevado é medida objetiva que justifica isoladamente a conclusão de inaptidão à função.', ok: false,
      why: 'Errada. A avaliação é funcional e considera a exigência real da função.' },
    { t: 'O índice isolado não é critério de aptidão, e as condições de trabalho não influenciam a síndrome metabólica.', ok: false,
      why: 'Errada. Turnos, sedentarismo imposto e oferta alimentar têm influência documentada.' },
    { t: 'O índice isolado não é critério de aptidão, sendo programas de emagrecimento com metas individuais a resposta da empresa.', ok: false,
      why: 'Errada. Meta corporal individual gera pressão e discriminação sem alterar os determinantes.' },
    { t: 'O índice isolado orienta a conduta, tornando dispensável a avaliação de capacidade funcional quando está elevado.', ok: false,
