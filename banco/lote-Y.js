...
{ id: 'q-4.5-080', tema: '4.5', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'A dificuldade de fala em ruído precede a queixa de ouvir pouco, pois as agudas é que levam as consoantes', ok: true,
...
{ id: 'q-4.8-080', tema: '4.8', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'Aminas aromáticas de corantes e da borracha têm associação com o desfecho, e a latência é longa', ok: true,
...
{ id: 'q-5.4-090', tema: '5.4', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'Depende da expectativa de recuperação, e a permanência não exige irreversibilidade absoluta do quadro', ok: true,
...
{ id: 'q-5.5-080', tema: '5.5', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'O efeito conjunto pode superar a soma isolada, devendo-se descrever a limitação funcional resultante', ok: true,
...
{ id: 'q-2.7-070', tema: '2.7', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'Combina o índice de sobrecarga térmica com a taxa metabólica estimada da atividade executada ali', ok: true,
