...
{ id: 'q-2.6-031', tema: '2.6', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    { t: 'Indicam a concentração esperada em quem se expõe ao limite ambiental do agente.', ok: true,
      why: 'Correta. Servem para verificar a absorção real, não são fronteira entre saúde e doença.' },
    { t: 'Indicam o nível a partir do qual há doença estabelecida no trabalhador que se expõe ao agente.', ok: false,
      why: 'Errada. Não são fronteira entre saúde e doença.' },
    { t: 'Indicam a absorção real do agente e substituem integralmente a avaliação ambiental da exposição.', ok: false,
      why: 'Errada. São complementares: uma mede a pessoa, a outra indica onde intervir.' },
    { t: 'Indicam a concentração esperada e são aplicáveis independentemente do momento da coleta.', ok: false,
      why: 'Errada. O momento da coleta é definido pela cinética do agente.' },
    { t: 'Indicam a absorção, garantindo valores abaixo da referência a ausência de risco individual.', ok: false,
...
{ id: 'q-1.3-030', tema: '1.3', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'É significativo e, sendo a doença rara, a razão de chances aproxima o risco relativo.', ok: true,
      why: 'Correta. O desenho segue vulnerável ao viés de memória na aferição da exposição.' },
    { t: 'É significativo, equivalendo a razão de chances ao risco relativo em qualquer situação estudada.', ok: false,
      why: 'Errada. A aproximação vale quando a doença é rara.' },
    { t: 'É significativo, permitindo o desenho de caso-controle calcular a incidência nos expostos.', ok: false,
      why: 'Errada. Caso-controle não permite estimar incidência.' },
    { t: 'O intervalo de confiança apresentado indica ausência de significância estatística no resultado.', ok: false,
      why: 'Errada. Um intervalo que não inclui o valor nulo indica significância.' },
    { t: 'É significativo, sendo o caso-controle o desenho de escolha para estimar prevalência da doença.', ok: false,
      why: 'Errada. Prevalência se estima em estudos transversais.' }
  ],
