...
{ id: 'q-7.5-041', tema: '7.5', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'Reproduz os dados do atestado, e o médico responde pela veracidade daquilo que ele atesta', ok: true,
...
{ id: 'q-7.8-041', tema: '7.8', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    { t: 'Deve conter os riscos avaliados, os exames realizados e a conclusão de aptidão, sem diagnósticos', ok: true,
