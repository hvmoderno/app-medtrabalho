...
{ id: 'q-4.4-160', tema: '4.4', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    ...
    { t: 'Além da limitação funcional há repercussão psicológica, mas a visibilidade da lesão não altera o impacto percebido pelo trabalhador.', ok: false,
      why: 'Errada. Lesões em mãos e face têm repercussão social específica, justamente por serem vistas.' },
    { t: 'Além da limitação funcional há repercussão social, mas a cronificação do quadro não altera a repercussão sobre a qualidade de vida.', ok: false,
      why: 'Errada. A cronificação amplia substancialmente o impacto sobre a vida do trabalhador.' },
    { t: 'Além da limitação funcional há repercussão social, mas quadros que não geram afastamento dispensam a atenção do serviço ocupacional.', ok: false,
      why: 'Errada. Ausência de afastamento não indica ausência de impacto nem de necessidade de intervenção.' }
  ],
...
{ id: 'q-5.5-150', tema: '5.5', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    ...
    { t: 'Segue critérios técnicos, sendo a idade avançada critério suficiente para afastar de saída a viabilidade de reabilitação profissional.', ok: false,
      why: 'Errada. É fator a considerar na viabilidade, e não critério isolado de exclusão.' },
    { t: 'Segue critérios técnicos que devem ser aplicados com maior rigor a trabalhadores mais velhos, dada a menor capacidade de recuperação.', ok: false,
      why: 'Errada. Aplicar critérios distintos por idade é discriminação.' },
    { t: 'Segue critérios técnicos, e a capacidade funcional pode ser estimada a partir da idade cronológica quando não há exames disponíveis.', ok: false,
      why: 'Errada. A variabilidade entre pessoas da mesma idade é ampla; a avaliação é individual.' }
  ],
...
{ id: 'q-7.4-150', tema: '7.4', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    ...
    { t: 'Existem para organizar o gerenciamento, e a divergência entre documento e prática é achado raro nas investigações de acidentes graves.', ok: false,
      why: 'Errada. É um dos achados mais recorrentes justamente nessas investigações.' },
    { t: 'Existem para atender à exigência normativa, podendo descrever o processo em termos gerais, sem espelhar a operação real da empresa.', ok: false,
      why: 'Errada. Documento que não descreve o processo real não organiza nem demonstra coisa alguma.' },
    { t: 'Existem para organizar o gerenciamento, e sua atualização é devida apenas na periodicidade máxima prevista para cada documento.', ok: false,
      why: 'Errada. Mudanças no processo exigem atualização antecipada, sem esperar o prazo.' }
  ],
