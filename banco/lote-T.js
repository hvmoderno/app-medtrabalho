...
{ id: 'q-6.1-070', tema: '6.1', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'A periodicidade decorre do risco, da idade e da existência de condições que exijam acompanhamento próximo', ok: true,
...
{ id: 'q-5.5-070', tema: '5.5', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'As tabelas padronizam o dano anatômico, mas não substituem a análise da repercussão sobre a atividade', ok: true,
...
{ id: 'q-7.7-033', tema: '7.7', tipo: 'autoral', fonte: null, nivel: 'dificil',
  ...
  alts: [
    { t: 'Deve trazer identificação, data e tempo de afastamento, e o código diagnóstico apenas com autorização', ok: true,
