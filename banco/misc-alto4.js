...
{ id: 'q-7.3-031', tema: '7.3', tipo: 'autoral', fonte: null, nivel: 'intermediario',
  ...
  alts: [
    ...
    { t: 'É documento obrigatório, sendo sua guarda no almoxarifado suficiente para cumprir a finalidade.', ok: false,
      why: 'Errada. Deve estar acessível no local de uso.' },
    { t: 'É documento obrigatório, dispensando as informações de socorro nele contidas protocolo próprio.', ok: false,
      why: 'Errada. A empresa precisa ter protocolo definido e treinado.' },
    { t: 'É documento obrigatório, dispensado quando o produto traz rótulo completo e padronizado.', ok: false,
      why: 'Errada. Rótulo e ficha são complementares, com detalhamentos distintos.' }
  ],
